					...
					<div class="table100-head">
						...
						<table>
							<thead>
								...
								<tr>
									<th colspan="5" ><h1 align="center">Driver Details<h1></th>
										<tr><th></th></tr>												
								</tr>
...
<?php
	...
	$results=mysqli_query($link, "select * from driver"); 
	
	echo '<center><table ><tr class="row100 head"><th>Name</th><th>Contact</th><th>Address</th><th>Experience</th></tr>';
		
	while ($row = mysqli_fetch_array($results))
	{
echo '<tr><td>'.$row['name'].'</td><td>'.$row['contact'].'</td><td>'.$row['address'].'</td><td>'.$row['experience'].'</td></tr>';
	}
		echo '</center>';
