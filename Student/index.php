					...
					<div class="row">
						<div class="col">
							<div class="top_bar_container d-flex flex-row align-items-center justify-content-start">
								...
								<h1><font color="white">Student Panel!</font></h1>
								...
								<div class="main_menu_content">
									<ul class="main_menu_list">
										...
										<li class="hassubs">
											...
											<ul>
												<li><a href="viewbuses.php">View Bus
												...
												<li><a href="busrequest.php">Bus Request
												...
												<li><a href="cancel.php">Cancellation
									...
									<!--	<li class="hassubs">
										...
										<li><a href="editprofile.php">Edit Profile
				...
				<div class="col-lg-6">
					<div class="intro_content">
						<div class="intro_title_container">
							...
							<h1 class="intro_title">Transport Facility</h1>
						</div>
						<div class="intro_text">
							<p>SBBS University provides bus facility for students and staff members and it covers every corner of the City and near about areas. College owns fleet of 15 buses equipped with safety features fire extinguishers, First-aid Box. Opting for College Bus transport will enable safe transport and convenience.
</p>
						</div>
