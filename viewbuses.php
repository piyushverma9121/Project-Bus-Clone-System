...
<body>
	...
	<div class="limiter">
		<h1 align="center">College Bus Details</h1>
						...
						<table>
							<thead>
								...
								<tr class="row100 head">
									<th class="cell100 column1">Bus No.</th>
							...
							<tbody>
								<?php
									...
									if (!$link) 
										...
										$results=mysqli_query($link, "select * from bustbl"); 
																

										while ($row = mysqli_fetch_array($results))
										{
											echo '<tr class="row100 body"><td class="cell100 column1">'.$row['busno'].'</td><td cell100 column2>'.$row['source'].'</td><td cell100 column3>'.$row['destination'].'</td></tr>';
										}
										echo "</tr></tbody>";
