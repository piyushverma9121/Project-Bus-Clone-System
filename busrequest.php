...
if(isset($_POST['search']))
{
	...
	else
	{
		...
		echo "<div id='sty1'><form name='booking' action='booking.php' metho='post'><table align='center' ><th>Bus No.</th><th>Source</th>
		<th>Destination</th><th>Driver No.</th><th>Fare</th>";
			session_start();
