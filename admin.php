...
<div id="div1">
<form id="form1" name="form1" method="post" action="adminlog.php">
  <table width="415" height="208" border="0"  align="center">
    <tbody>
      <tr>
        <th colspan="2" scope="row"><h1><u>Admin Login</u></h1></th>
      </tr>
      <tr>
      ...
      <tr>
        <th colspan="2" scope="row"><input name="username" type="text" required="required" id="username" placeholder="Username" size="30"></th>
        </tr>
      <tr>
        <th scope="row">&nbsp;</th>
        <td>&nbsp;</td>
