...
<div id="div1">
<form id="form1" name="form1" method="post" action="studentlog.php">
  <table width="415" height="208" border="0"  align="center">
    <tbody>
      <tr>
        <th colspan="2" scope="row"><h1><u>Student Login</u></h1></th>
      </tr>
      <tr>
      ...
      <tr>
        <th colspan="2" scope="row"><input name="username" type="text" required="required" id="username" placeholder="studentid" size="30"></th>
        </tr>
      <tr>
        <th scope="row">&nbsp;</th>
        <td>&nbsp;</td>
