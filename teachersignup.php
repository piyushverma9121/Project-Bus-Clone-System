...
<form id="form1" name="form1" method="post">
  <table width="491" height="426" border="0" align="center">
    <tbody>
      <tr>
		  <th colspan="2" scope="row"><h1><strong><u>Teacher Signup Here</u></strong></h1></th>
      </tr>
      <tr>
        <th scope="row">Teacher ID</th>
        <td><input name="tid" type="text" required="required" id="sid" size="40"></td>
      </tr>
      <tr>
        <th scope="row">&nbsp;</th>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td><input name="tname" type="text" id="sname" size="40"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input name="dept" type="text" required="required" id="phno" size="40"></td>
      </tr>
      <tr>
        <th scope="row">&nbsp;</th>
        <td>&nbsp;</td>
...
if(isset($_POST['submit']))
{
	...
	else
	{
		...
		mysqli_query($link, "INSERT INTO teacher(Teacherid,name,department,email,gender,address,contact,password,status) VALUES ('$one', '$two','$eight','$four','$gen','$six','$seven','$three','Active')"); 
	}
}
